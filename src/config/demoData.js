// Date demo potrivite pentru fiecare tip de workspace
...
export const getDemoPatients = (workspaceType) => {
  ...
  if (type === "hotel") {
    return [
      ...
      {
        name: "Ana Dima",
        email: "ana.dima@email.com",
        phone: "0720 445 987",
        dePlata: "650 RON",
        upcoming: "Cazare Double - 13 feb, 14:00",
      },
      {
        name: "Radu Georgescu",
        email: "radu.georgescu@email.com",
        phone: "0746 208 315",
        dePlata: "180 RON",
        upcoming: "Cazare Single - 13 feb, 15:00",
      },
      {
        name: "Carmen Iacob",
        ...
        phone: "0736 553 112",
        dePlata: "0 RON",
        upcoming: "Suite Premium - 14 feb, 16:00",
      },
      {
        name: "Stefan Popescu",
        ...
        phone: "0712 631 940",
        dePlata: "890 RON",
        upcoming: "Masaj relaxare - 14 feb, 17:00",
      },
      {
        name: "Laura Pop",
        email: "laura.pop@email.com",
        phone: "0732 118 546",
        dePlata: "220 RON",
        upcoming: "Cazare Double - 15 feb, 14:00",
      },
    ]
  }
  ...
  if (type === "fitness") {
    return [
      ...
      },
      {
        ...
        phone: "0720 445 987",
        dePlata: "650 RON",
        upcoming: "Abonament Premium - 13 feb, 10:00",
      },
      {
        name: "Radu Georgescu",
        email: "radu.georgescu@email.com",
        phone: "0746 208 315",
        dePlata: "180 RON",
        upcoming: "Abonament Standard - 13 feb, 14:00",
      },
      {
        name: "Carmen Iacob",
        email: "carmen.iacob@email.com",
        phone: "0736 553 112",
        dePlata: "0 RON",
        upcoming: "Pachet Antrenament Personal - 14 feb, 11:00",
      },
      {
        name: "Stefan Popescu",
        email: "stefan.popescu@email.com",
        phone: "0712 631 940",
        dePlata: "890 RON",
        upcoming: "Consult nutriție - 14 feb, 16:00",
      },
      {
        name: "Laura Pop",
        email: "laura.pop@email.com",
        phone: "0732 118 546",
        dePlata: "220 RON",
        upcoming: "Pachet grup - 15 feb, 08:00",
      },
    ]
  }
...
export const getDemoClients = (workspaceType) => {
  ...
  console.log("getDemoClients - workspaceType:", workspaceType, "normalized type:", type)
  
  if (type === "fitness") {
    const patients = getDemoPatients(workspaceType)
    console.log("getDemoClients - patients for fitness:", patients)
    const clients = patients.slice(0, 6).map((patient, index) => ({
      id: `client-${index + 1}`,
      name: patient.name,
      phone: patient.phone,
      email: patient.email,
      package: patient.upcoming?.split(" - ")[0] || "Abonament Standard",
      color: ["#6366F1", "#0EA5E9", "#22C55E", "#F97316", "#8B5CF6", "#EC4899"][index % 6],
    }))
    console.log("getDemoClients - generated clients:", clients)
    return clients
  }
...
export const getDemoAppointments = (workspaceType, doctors) => {
  const type = normalizeWorkspaceType(workspaceType)
  ...
  if (type === "fitness") {
    ...
    return [
      ...
      },
      {
        ...
        clientName: clients[3]?.name || "Elena Stan",
        training: "Consult nutriție",
        start: 16 * 60, // 16:00
        startMinutes: 16 * 60,
        duration: 45,
        status: "confirmată",
      ...
      {
        id: "fitness-appt-7",
        clientId: clients[4]?.id || "client-5",
        clientName: clients[4]?.name || "Dan Pop",
        training: "Pachet grup",
        start: 8 * 60 + 30, // 08:30
      ...
      {
        id: "fitness-appt-8",
        clientId: clients[5]?.id || "client-6",
        clientName: clients[5]?.name || "Ana Dima",
        training: "Antrenament Cardio",
        start: 10 * 60, // 10:00
        startMinutes: 10 * 60,
        duration: 45,
  ...
  return [
    {
      id: "appt-1",
      doctorId: doctors[0]?.id || "dr-ionescu",
    ...
    {
      id: "appt-3",
      doctorId: doctors[1]?.id || "dr-popescu",
      patient: "Maria Tudor",
